...
2. Install the script:
   ...
   **[Install Script](OpenFrontIO-TroopTiming.user.js)**

   Or copy the contents of `OpenFrontIO-TroopTiming.user.js` into a new Tampermonkey script.
...
Source code is licensed under AGPL v3. See [OpenFrontIO/LICENSE](https://github.com/openfrontio/OpenFrontIO/blob/main/LICENSE) for details.
